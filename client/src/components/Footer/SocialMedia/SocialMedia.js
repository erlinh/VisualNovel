  ...
  return(
    <div className="col col-md-auto mr-md-8 ">
      ...
      <ul className="mt-3" style={{listStyle:'none'}}>
        <li><Link className="pt-2" to="#"><i className="fab fa-facebook" style={{fontSize:'25px'}}></i></Link></li>
        <li><Link className="pt-2" to="#"><i className="fab fa-twitter" style={{fontSize:'25px'}}></i></Link></li>
